...
const int WEIGHTS_COMBO_4[25] =
	{ 26,  16,  40,  33,  22,  27,  23, -31, -17,  -2, -28,  14,   0,   4,  -7,  31,   1,   1, -39,  11,   7,  -6, -27, -32, -18 };

// Generated by hand
const int WEIGHTS_COMBO_5[25] =
{
	1200, // 1.) # of Pawns 
	3200, // 2.) # of Kings
	0, //50,  // 3.) # of safe Pawns
	0, //150, // 4.) # of safe Kings
	0, //20,  // 5.) # of moveable pawns (able to make a move other than capture)
	0, //60,  // 6.) # of moveable kings (able to make a move other than capture)
	0, //-10,  // 7.) Aggregated distance of Pawns to promotion line
	0, //-30, // 8.) # of unoccupied fields on promotion line
	0, //30,  // 9.) # of defender pieces (pieces in 2 lower most rows)
	0, //30,  // 10.) # of attacking pawns (pieces in 3 upper most rows)
	0, //30,  // 11.) # of centrally positioned pawns (pawns in 8 central positions on board)
	0, //50,  // 12.) # of centrally positioned kings 
	0, //10,  // 13.) # of pawns positioned on the main diagonal
	0, //10,  // 14.) # of kings positioned on the main diagonal
	0, //5,   // 15.) # of pawns positioned on the double diagonal
	0, //5,   // 16.) # of kings positioned on the double diagonal
	0, //-20, // 17.) # on loner pawns (pawn not adjacent to any other piece)
	0, //-60, // 18.) # of loner kings (king not adjacent to any other piece)
	0, //-20, // 19.) # of holes (empty spaces adjacent to at least 3 pieces of the same color)
	0, //0,   // 20.) Presence of a Triangle pattern *  Not yet counted
	0, //0,   // 21.) Presence of an Oreo pattern *  Not yet counted
	0, //0,   // 22.) Presence of a Bridge pattern *  Not yet counted
	0, //0,   // 23.) Presence of a Dog pattern *  Not yet counted
	0, //5,   // 24.) Presence of a pawn in corner
	0, //5 	 // 25.) Presence of a king in corner
};
